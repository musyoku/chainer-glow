...
def main():
    ...
    dataset = glow.data.Dataset(args.dataset_path)
    ...
    for iteration in range(args.training_steps):
        ...
        for subset_index, subset in enumerate(dataset):
            iterator = glow.data.Iterator(subset, batch_size=args.batch_size)
            ...
            for batch_index, data_indices in enumerate(iterator):
                ...
                for l in range(model.generation_steps):
                    ...
                    kld = glow.nn.chainer.functions.gaussian_kl_divergence(
                ...
                negative_log_likelihood = glow.nn.chainer.functions.gaussian_negative_log_likelihood(
